...
class SubscriptionQueryResponse(object):
    ...
    """Implementation of the 'SubscriptionQueryResponse' model.
    ...
    Attributes:
        ...
        license_used_count (int): Number of licenses currently assigned to
            devices.
        update_time (datetime): The date and time of when the subscription was
            last updated.
    ...
    def __init__(self,
        ...
        """Constructor for the SubscriptionQueryResponse class"""
