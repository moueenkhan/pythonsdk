...
from mergedapi.models.device_list_query_item import DeviceListQueryItem


class DeviceListQueryResponse(object):

    """Implementation of the 'DeviceListQueryResponse' model.
    ...
    def __init__(self,
        ...
        """Constructor for the DeviceListQueryResponse class"""
