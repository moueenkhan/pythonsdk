...
class PerformanceApiRequest(object):

    """Implementation of the 'PerformanceApiRequest' model.

    Request to query the most recent data for Key Performance Indicators
    ...
    def __init__(self,
                 imei=None,
                 msisdn=None):
        """Constructor for the PerformanceApiRequest class"""
