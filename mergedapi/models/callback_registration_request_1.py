...
class CallbackRegistrationRequest1(object):

    """Implementation of the 'CallbackRegistrationRequest1' model.
    ...
    def __init__(self,
        ...
        """Constructor for the CallbackRegistrationRequest1 class"""
