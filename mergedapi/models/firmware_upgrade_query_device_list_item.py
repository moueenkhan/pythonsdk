...
class FirmwareUpgradeQueryDeviceListItem(object):

    """Implementation of the 'FirmwareUpgradeQueryDeviceListItem' model.
    ...
    def __init__(self,
        ...
        """Constructor for the FirmwareUpgradeQueryDeviceListItem class"""
