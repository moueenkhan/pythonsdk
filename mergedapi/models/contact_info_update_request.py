...
class ContactInfoUpdateRequest(object):
    ...
    Attributes:
        ...
        devices (list of DeviceList): A list of the devices that you want to
            change, specified by device identifier. You only need to provide
            one identifier per device. Do not include accountName, groupName,
