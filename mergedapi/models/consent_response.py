...
class ConsentResponse(object):
    ...
    """Implementation of the 'ConsentResponse' model.

    TODO: type model description here.

    Attributes:
        account_name (string): Account identifier in "##########-#####"
        all_device (bool): Exclude all devices
        has_more_data (bool): More devices to retrieve
    ...
    def __init__(self,
        ...
        """Constructor for the ConsentResponse class"""
