...
class ChangeCampaignDatesRequest(object):

    """Implementation of the 'ChangeCampaignDatesRequest' model.
    ...
    Attributes:
        ...
        download_after_date (date): Specifies starting date client should
            ...
            possible.
        download_time_window_list (list of TimeWindow): List of allowed
        ...
        install_time_window_list (list of TimeWindow): List of allowed install
    ...
    def __init__(self,
        ...
        """Constructor for the ChangeCampaignDatesRequest class"""
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('downloadTimeWindowList') is not None:
            download_time_window_list = [TimeWindow.from_dictionary(x) for x in dictionary.get('downloadTimeWindowList')]
        else:
            download_time_window_list = APIHelper.SKIP
        ...
        if dictionary.get('installTimeWindowList') is not None:
            install_time_window_list = [TimeWindow.from_dictionary(x) for x in dictionary.get('installTimeWindowList')]
        else:
            install_time_window_list = APIHelper.SKIP
