...
from mergedapi.models.ip_pool import IPPool
from mergedapi.models.service_plan_response import ServicePlanResponse


class AccountInformationResponse(object):

    """Implementation of the 'AccountInformationResponse' model.
    ...
    Attributes:
        ...
        i_p_pools (list of IPPool): Array of IP pools that are available to
            the account.
        service_plans (list of ServicePlanResponse): Array of service plans
            that are available to the account.
    ...
    def __init__(self,
        ...
        """Constructor for the AccountInformationResponse class"""
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('servicePlans') is not None:
            service_plans = [ServicePlanResponse.from_dictionary(x) for x in dictionary.get('servicePlans')]
        else:
            service_plans = APIHelper.SKIP
