...
"""
from mergedapi.models.device_status_1 import DeviceStatus1


class LicenseResponse1(object):

    """Implementation of the 'LicenseResponse1' model.
    ...
    Attributes:
        ...
        device_list (list of DeviceStatus1): List of devices with id in IMEI
    ...
    def __init__(self,
                 ...
                 lic_used_count=None,
                 device_list=None):
        """Constructor for the LicenseResponse1 class"""
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('deviceList') is not None:
            device_list = [DeviceStatus1.from_dictionary(x) for x in dictionary.get('deviceList')]
