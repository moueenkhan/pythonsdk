...
class CancellationCandidateCreateResponse(object):

    """Implementation of the 'cancellationCandidateCreateResponse' model.
    ...
    def __init__(self,
        ...
        """Constructor for the CancellationCandidateCreateResponse class"""
