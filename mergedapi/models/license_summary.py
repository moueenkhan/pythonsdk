...
from mergedapi.models.license_device import LicenseDevice


class LicenseSummary(object):

    """Implementation of the 'LicenseSummary' model.
    ...
    Attributes:
        ...
        device_list (list of LicenseDevice): Device IMEI list
    ...
    def __init__(self,
        ...
        """Constructor for the LicenseSummary class"""
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('deviceList') is not None:
            device_list = [LicenseDevice.from_dictionary(x) for x in dictionary.get('deviceList')]
        else:
            device_list = APIHelper.SKIP
