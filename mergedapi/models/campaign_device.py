...
class CampaignDevice(object):

    """Implementation of the 'CampaignDevice' model.
    ...
    Attributes:
        ...
        device_list (list of DeviceStatus): List of devices with id in IMEI
    ...
    def __init__(self,
        ...
        """Constructor for the CampaignDevice class"""
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('deviceList') is not None:
            device_list = [DeviceStatus.from_dictionary(x) for x in dictionary.get('deviceList')]
