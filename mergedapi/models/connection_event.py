...
class ConnectionEvent(object):
    ...
    Attributes:
        connection_event_attributes (list of KvPair): The attributes that
            describe the connection event.
        extended_attributes (list of KvPair): Currently not used.
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('connectionEventAttributes') is not None:
            connection_event_attributes = [KvPair.from_dictionary(x) for x in dictionary.get('connectionEventAttributes')]
        else:
            connection_event_attributes = APIHelper.SKIP
