...
class FileServiceRes(object):

    """Implementation of the 'fileServiceRes' model.

    Response to get file of a service.

    Attributes:
        id (string): system generated unique UUID
        service_name (string): ServiceName to which the file is going to be
            associated.
    ...
    def __init__(self,
        ...
        """Constructor for the FileServiceRes class"""
