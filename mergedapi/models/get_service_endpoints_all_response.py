...
class GetServiceEndpointsAllResponse(object):

    """Implementation of the 'GetServiceEndpointsAllResponse' model.
    ...
    def __init__(self,
                 status='success',
                 data=APIHelper.SKIP):
        """Constructor for the GetServiceEndpointsAllResponse class"""
