...
from mergedapi.models.metadata_annotations import MetadataAnnotations
from mergedapi.models.metadata_labels import MetadataLabels
...
class Metadata(object):
    ...
    Attributes:
        ...
        labels (MetadataLabels): TODO: type description here.
        annotations (MetadataAnnotations): TODO: type description here.
    ...
    def from_dictionary(cls,
        ...
        labels = MetadataLabels.from_dictionary(dictionary.get('labels')) if 'labels' in dictionary.keys() else APIHelper.SKIP
        annotations = MetadataAnnotations.from_dictionary(dictionary.get('annotations')) if 'annotations' in dictionary.keys() else APIHelper.SKIP
