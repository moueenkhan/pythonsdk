...
from mergedapi.models.cluster_infra import ClusterInfra
from mergedapi.models.cluster_metadata import ClusterMetadata
from mergedapi.models.eds_discovery_intent import EdsDiscoveryIntent
from mergedapi.models.params import Params
from mergedapi.models.region_item import RegionItem
from mergedapi.models.revision import Revision
from mergedapi.models.virtual_machine import VirtualMachine
from mergedapi.models.workload import Workload


class ServiceInstanceResp(object):

    """Implementation of the 'ServiceInstanceResp' model.
    ...
    Attributes:
        ...
        workload (list of Workload): TODO: type description here.
    ...
    def __init__(self,
        ...
        """Constructor for the ServiceInstanceResp class"""
    ...
    def from_dictionary(cls,
        ...
        labels = Params.from_dictionary(dictionary.get('labels')) if 'labels' in dictionary.keys() else APIHelper.SKIP
        ...
        if dictionary.get('workload') is not None:
            workload = [Workload.from_dictionary(x) for x in dictionary.get('workload')]
        else:
            workload = APIHelper.SKIP
