...
from mergedapi.models.account_device_1 import AccountDevice1


class AccountDeviceList1(object):

    """Implementation of the 'AccountDeviceList1' model.
    ...
    Attributes:
        ...
        device_list (list of AccountDevice1): Account device list
    ...
    def __init__(self,
        ...
        """Constructor for the AccountDeviceList1 class"""
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('deviceList') is not None:
            device_list = [AccountDevice1.from_dictionary(x) for x in dictionary.get('deviceList')]
