...
class PerformanceApiResponse(object):

    """Implementation of the 'PerformanceApiResponse' model.
    ...
    Attributes:
        ...
        start (string): Timestamp of the query's start,
            ...
            hr:min:sec
        query_result (list of Result): Result of the query to fetch the most
            recent data for Key Performance Indicators (KPIs) like network
    ...
    def __init__(self,
        ...
        """Constructor for the PerformanceApiResponse class"""
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('QueryResult') is not None:
            query_result = [Result.from_dictionary(x) for x in dictionary.get('QueryResult')]
        else:
            query_result = APIHelper.SKIP
