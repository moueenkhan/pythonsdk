...
class HelmGitBranch1(object):

    """Implementation of the 'helmGitBranch1' model.

    helmGitBranch would have branchName, helmChartPath, and valuesYAMLPaths
    attributes.
    ...
    def __init__(self,
        ...
        """Constructor for the HelmGitBranch1 class"""
