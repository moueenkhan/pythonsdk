...
from mergedapi.models.condition_item import ConditionItem
from mergedapi.models.extra import Extra
from mergedapi.models.status_node_item import StatusNodeItem
from mergedapi.models.status_project_item import StatusProjectItem
...
class ClusterStatus(object):
    ...
    Attributes:
        ...
        nodes (list of StatusNodeItem): TODO: type description here.
        ...
        extra (Extra): TODO: type description here.
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('nodes') is not None:
            nodes = [StatusNodeItem.from_dictionary(x) for x in dictionary.get('nodes')]
        else:
            nodes = APIHelper.SKIP
        ...
        if dictionary.get('projects') is not None:
            ...
            projects = APIHelper.SKIP
        extra = Extra.from_dictionary(dictionary.get('extra')) if 'extra' in dictionary.keys() else APIHelper.SKIP
