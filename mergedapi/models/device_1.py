...
from mergedapi.models.carrier_information import CarrierInformation
...
class Device1(object):
    ...
    Attributes:
        ...
        created_at (string): The date and time that the device was added to
            the system.
        custom_fields (list of KvPair): The custom fields and values that have
        ...
        extended_attributes (list of KvPair): Any extended attributes for the
            device, as Key and Value pairs. The pairs listed below are
