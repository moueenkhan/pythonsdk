...
from mergedapi.models.service_usage import ServiceUsage


class UsageResponse(object):

    """Implementation of the 'UsageResponse' model.

    bill usage response

    Attributes:
        account_name (string): Account identifier
        usage_for_all_accounts (bool): The usage is for a sinlge or multiple
            accounts
