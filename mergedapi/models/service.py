...
from mergedapi.models.boundary import Boundary
from mergedapi.models.compatibility import Compatibility
from mergedapi.models.error_response_1 import ErrorResponse1
from mergedapi.models.observability_template import ObservabilityTemplate
from mergedapi.models.params_1 import Params1
from mergedapi.models.resource import Resource
from mergedapi.models.service_dependency import ServiceDependency
from mergedapi.models.service_error import ServiceError
from mergedapi.models.service_handler_id import ServiceHandlerId
from mergedapi.models.service_swagger_spec_id import ServiceSwaggerSpecId
from mergedapi.models.service_tag import ServiceTag
from mergedapi.models.workflow import Workflow
from mergedapi.models.workload_1 import Workload1
...
class Service(object):
    ...
    Attributes:
        ...
        description (string): Description of the service needs to be deployed
        version (string): Version of the service needs to be deployed
        metadata (list of Params1): Properties are metadata attributes.
        tags (list of ServiceTag): List of serviceTags.
        ...
        compatibility (list of Compatibility): Compatibility would have the
            attribute csp which is Cloud service provider ex:
            AWS_PUBLIC_CLOUD, AWS_WL, AWS_OUTPOST, AZURE_EDGE,
            AZURE_PUBLIC_CLOUD.
        resource (Resource): Resource of the service.
        ...
        error_response (ErrorResponse1): ErrorResponse attribute of a
            service.
        state (StateEnum): Can have any value as - DRAFT, DESIGN, TESTING,
            PUBLISH, CERTIFY, READY_TO_USE, DEPRECATE, DELETED.
        status (Status1Enum): Can have any value as - DRAFT_INPROGRESS,
        ...
        mtype (ServiceTypeEnum): Service Type. Ex: Installation, Operations,
            Custom.
        ...
        service_swagger_spec_id (ServiceSwaggerSpecId): Auto generated Id of
            service handler swagger spec file uploaded.
        workflows (list of Workflow): workflow attribute of a service.
        workloads (list of Workload1): workload attribute of a service.
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('metadata') is not None:
            metadata = [Params1.from_dictionary(x) for x in dictionary.get('metadata')]
        else:
            metadata = APIHelper.SKIP
        tags = None
        ...
        is_favourite = dictionary.get("isFavourite") if dictionary.get("isFavourite") else False
        is_deleted = dictionary.get("isDeleted") if dictionary.get("isDeleted") else False
        compatibility = None
        if dictionary.get('compatibility') is not None:
            ...
            compatibility = APIHelper.SKIP
        resource = Resource.from_dictionary(dictionary.get('resource')) if 'resource' in dictionary.keys() else APIHelper.SKIP
        ...
        error_response = ErrorResponse1.from_dictionary(dictionary.get('errorResponse')) if 'errorResponse' in dictionary.keys() else APIHelper.SKIP
        ...
        if dictionary.get('workloads') is not None:
            workloads = [Workload1.from_dictionary(x) for x in dictionary.get('workloads')]
        else:
            workloads = APIHelper.SKIP
        dependencies = None
        if dictionary.get('dependencies') is not None:
            ...
            dependencies = APIHelper.SKIP
        boundaries = None
        if dictionary.get('boundaries') is not None:
            boundaries = [Boundary.from_dictionary(x) for x in dictionary.get('boundaries')]
        else:
            boundaries = APIHelper.SKIP
