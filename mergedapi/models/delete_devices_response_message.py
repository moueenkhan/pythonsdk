...
class DeleteDevicesResponseMessage(object):

    """Implementation of the 'DeleteDevicesResponseMessage' model.
    ...
    def __init__(self,
        ...
        """Constructor for the DeleteDevicesResponseMessage class"""
