...
class CancellationCandidateQueryResponse(object):

    """Implementation of the 'cancellationCandidateQueryResponse' model.
    ...
    def __init__(self,
        ...
        """Constructor for the CancellationCandidateQueryResponse class"""
