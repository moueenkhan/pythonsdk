...
from mergedapi.models.credentials_1 import Credentials1


class Repository1(object):

    """Implementation of the 'repository1' model.
    ...
    Attributes:
        ...
        mtype (RepositoryTypeEnum): Type for the repository which can be Git
            or Helm.
        ...
        reacheability (ReacheabilityEnum): Reachability can be of two types,
        ...
        credentials_type (CredentialsTypeEnum): credentialsType can be of two
            types, UserPassCredentials and SSHCredentials.
        credentials (Credentials1): Credentials of a repository.
    ...
    def __init__(self,
                 ...
                 is_deleted=False):
        """Constructor for the Repository1 class"""
    ...
    def from_dictionary(cls,
        ...
        credentials = Credentials1.from_dictionary(dictionary.get('credentials')) if 'credentials' in dictionary.keys() else APIHelper.SKIP
