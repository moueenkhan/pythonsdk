...
class CallbackRegistrationResponse1(object):

    """Implementation of the 'CallbackRegistrationResponse1' model.
    ...
    def __init__(self,
        ...
        """Constructor for the CallbackRegistrationResponse1 class"""
