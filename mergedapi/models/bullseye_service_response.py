...
from mergedapi.models.device_service_response import DeviceServiceResponse


class BullseyeServiceResponse(object):

    """Implementation of the 'BullseyeServiceResponse' model.

    Status of Hyper Precise Location on the device.

    Attributes:
        account_number (string): The account the device belongs to.
        device_list (list of DeviceServiceResponse): List of devices.
    ...
    def __init__(self,
        ...
        """Constructor for the BullseyeServiceResponse class"""
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('deviceList') is not None:
            device_list = [DeviceServiceResponse.from_dictionary(x) for x in dictionary.get('deviceList')]
        else:
            device_list = APIHelper.SKIP
