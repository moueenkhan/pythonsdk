...
class DeleteDevicesRequest(object):
    ...
    Attributes:
        ...
        devices_to_delete (list of DeviceList): A list of up to 100 devices
            that you want to delete, specified by device identifier. You only
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('devicesToDelete') is not None:
            devices_to_delete = [DeviceList.from_dictionary(x) for x in dictionary.get('devicesToDelete')]
        else:
            devices_to_delete = APIHelper.SKIP
