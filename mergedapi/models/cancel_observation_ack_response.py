...
class CancelObservationACKResponse(object):

    """Implementation of the 'CancelObservationACKResponse' model.
    ...
    def __init__(self,
                 ...
                 status=None,
                 created_on=None):
        """Constructor for the CancelObservationACKResponse class"""
