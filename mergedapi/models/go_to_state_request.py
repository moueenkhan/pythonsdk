...
from mergedapi.models.device_filter import DeviceFilter
from mergedapi.models.device_list import DeviceList
from mergedapi.models.kv_pair import KvPair
from mergedapi.models.place_of_use import PlaceOfUse
...
class GoToStateRequest(object):
    ...
    Attributes:
        devices (list of DeviceList): Up to 10,000 devices that you want to
            push to a different state, specified by device identifier.
        ...
        custom_fields (list of KvPair): The names and values of any custom
