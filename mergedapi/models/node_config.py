...
from mergedapi.models.labels import Labels
from mergedapi.models.list_string import ListString
from mergedapi.models.tags import Tags


class NodeConfig(object):

    """Implementation of the 'NodeConfig' model.
    ...
    Attributes:
        ...
        instance_role_permission_boundary (string): TODO: type description
            here.
        security_group_ids (list of ListString): TODO: type description here.
        availability_zone_ids (list of ListString): TODO: type description
            here.
        labels (Labels): TODO: type description here.
        tags (Tags): TODO: type description here.
    ...
    def __init__(self,
        ...
        """Constructor for the NodeConfig class"""
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('securityGroupIds') is not None:
            security_group_ids = [ListString.from_dictionary(x) for x in dictionary.get('securityGroupIds')]
        else:
            security_group_ids = APIHelper.SKIP
        availability_zone_ids = None
        if dictionary.get('availabilityZoneIds') is not None:
            availability_zone_ids = [ListString.from_dictionary(x) for x in dictionary.get('availabilityZoneIds')]
        else:
            availability_zone_ids = APIHelper.SKIP
        labels = Labels.from_dictionary(dictionary.get('labels')) if 'labels' in dictionary.keys() else APIHelper.SKIP
        tags = Tags.from_dictionary(dictionary.get('tags')) if 'tags' in dictionary.keys() else APIHelper.SKIP
