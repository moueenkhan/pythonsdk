...
class CustomFieldsUpdateRequest(object):
    ...
    Attributes:
        ...
        custom_fields_to_update (list of KvPair): The names and new values of
            any custom fields that you want to change.
        devices (list of DeviceList): The devices that you want to change.
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('customFieldsToUpdate') is not None:
            custom_fields_to_update = [KvPair.from_dictionary(x) for x in dictionary.get('customFieldsToUpdate')]
        else:
            custom_fields_to_update = APIHelper.SKIP
        devices = None
