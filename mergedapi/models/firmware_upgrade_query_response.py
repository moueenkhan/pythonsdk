...
from mergedapi.models.firmware_upgrade_query_device_list_item import FirmwareUpgradeQueryDeviceListItem


class FirmwareUpgradeQueryResponse(object):

    """Implementation of the 'FirmwareUpgradeQueryResponse' model.
    ...
    Attributes:
        ...
        device_list (list of FirmwareUpgradeQueryDeviceListItem): A JSON
            object for each device that was included in the upgrade, showing
            the device IMEI, the status of the upgrade, and additional
    ...
    def __init__(self,
        ...
        """Constructor for the FirmwareUpgradeQueryResponse class"""
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('deviceList') is not None:
            device_list = [FirmwareUpgradeQueryDeviceListItem.from_dictionary(x) for x in dictionary.get('deviceList')]
        else:
            device_list = APIHelper.SKIP
