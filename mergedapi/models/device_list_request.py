...
from mergedapi.models.device_list_filter import DeviceListFilter
from mergedapi.models.kv_pair import KvPair


class DeviceListRequest(object):
    ...
    Attributes:
        ...
        filter (DeviceListFilter): Filter for Devices List.
    ...
    def from_dictionary(cls,
        ...
        filter = DeviceListFilter.from_dictionary(dictionary.get('filter')) if 'filter' in dictionary.keys() else APIHelper.SKIP
