...
from mergedapi.models.service_instance_resp import ServiceInstanceResp


class GetService(object):

    """Implementation of the 'GetService' model.
    ...
    Attributes:
        ...
        status (string): status of the add service
        state (string): state of the service Instance
        service (ServiceInstanceResp): TODO: type description here.
    ...
    def __init__(self,
        ...
        """Constructor for the GetService class"""
    ...
    def from_dictionary(cls,
        ...
        service = ServiceInstanceResp.from_dictionary(dictionary.get('service')) if 'service' in dictionary.keys() else APIHelper.SKIP
