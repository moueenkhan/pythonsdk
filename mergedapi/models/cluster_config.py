...
class ClusterConfig(object):
    ...
    """Implementation of the 'ClusterConfig' model.

    TODO: type model description here.

    Attributes:
        tags (Params): TODO: type description here.
        end_point_access_type (ClusterConfigEndpPointAccessTypeEnum): TODO:
        ...
        availability_zones (list of ListString): TODO: type description here.
        private_network_infra_ids (list of ListString): TODO: type description
            here.
        public_network_infra_ids (list of ListString): TODO: type description
            here.
    ...
    def __init__(self,
        ...
        """Constructor for the ClusterConfig class"""
    ...
    def from_dictionary(cls,
        ...
        tags = Params.from_dictionary(dictionary.get('tags')) if 'tags' in dictionary.keys() else APIHelper.SKIP
        ...
        if dictionary.get('availabilityZones') is not None:
            availability_zones = [ListString.from_dictionary(x) for x in dictionary.get('availabilityZones')]
        else:
            availability_zones = APIHelper.SKIP
        private_network_infra_ids = None
        if dictionary.get('privateNetworkInfraIds') is not None:
            private_network_infra_ids = [ListString.from_dictionary(x) for x in dictionary.get('privateNetworkInfraIds')]
        else:
            private_network_infra_ids = APIHelper.SKIP
        public_network_infra_ids = None
        if dictionary.get('publicNetworkInfraIds') is not None:
            public_network_infra_ids = [ListString.from_dictionary(x) for x in dictionary.get('publicNetworkInfraIds')]
        else:
            public_network_infra_ids = APIHelper.SKIP
