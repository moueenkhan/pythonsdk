...
class Notificationarray(object):
    ...
    Attributes:
        ...
        notification_frequency_factor (int): Frequency factor for
            notification.
        notification_frequency_interval (int): Frequency interval for
            notification.
    ...
    def from_dictionary(cls,
        ...
        sms_numbers = dictionary.get("smsNumbers") if dictionary.get("smsNumbers") else APIHelper.SKIP
