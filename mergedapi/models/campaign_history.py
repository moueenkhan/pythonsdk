...
from mergedapi.models.campaign_meta_info import CampaignMetaInfo


class CampaignHistory(object):

    """Implementation of the 'CampaignHistory' model.
    ...
    Attributes:
        ...
        campaign_list (list of CampaignMetaInfo): Software upgrade list
    ...
    def __init__(self,
        ...
        """Constructor for the CampaignHistory class"""
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('campaignList') is not None:
            campaign_list = [CampaignMetaInfo.from_dictionary(x) for x in dictionary.get('campaignList')]
