...
class DeviceUpgradeHistoryQueryResponseItem(object):

    """Implementation of the 'DeviceUpgradeHistoryQueryResponseItem' model.
    ...
    def __init__(self,
        ...
        """Constructor for the DeviceUpgradeHistoryQueryResponseItem class"""
