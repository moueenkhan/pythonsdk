...
from mergedapi.models.account_device import AccountDevice
...
class AccountDeviceList(object):
    ...
    Attributes:
        ...
        device_list (list of AccountDevice): Account device list
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('deviceList') is not None:
            device_list = [AccountDevice.from_dictionary(x) for x in dictionary.get('deviceList')]
