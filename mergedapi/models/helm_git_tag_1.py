...
class HelmGitTag1(object):

    """Implementation of the 'helmGitTag1' model.

    helmGitTag would have tagName, helmChartPath, and valuesYAMLPaths
    attributes.
    ...
    def __init__(self,
        ...
        """Constructor for the HelmGitTag1 class"""
