...
from mergedapi.models.aws_csp_profile import AwsCspProfile
from mergedapi.models.azure_csp_profile import AzureCspProfile
from mergedapi.models.default_location import DefaultLocation
...
class Cspprofile(object):
    ...
    Attributes:
        ...
        project_name (string): Project name where service artifacts needs to
            be stored.
        mtype (CspProfileTypeEnum): Type of CspProfile
