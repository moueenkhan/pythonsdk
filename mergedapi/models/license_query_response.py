...
from mergedapi.models.license_query_device_list_item import LicenseQueryDeviceListItem


class LicenseQueryResponse(object):

    """Implementation of the 'LicenseQueryResponse' model.
    ...
    Attributes:
        ...
        device_list (list of LicenseQueryDeviceListItem): The list of devices
    ...
    def __init__(self,
        ...
        """Constructor for the LicenseQueryResponse class"""
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('deviceList') is not None:
            device_list = [LicenseQueryDeviceListItem.from_dictionary(x) for x in dictionary.get('deviceList')]
        else:
            device_list = APIHelper.SKIP
