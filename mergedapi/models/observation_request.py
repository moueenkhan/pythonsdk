...
from mergedapi.models.data_2 import Data2
...
class ObservationRequest(object):
    ...
    Attributes:
        ...
        frequency (Data2): Describes value and unit of time.
        duration (Data2): Describes value and unit of time.
    ...
    def from_dictionary(cls,
        ...
        frequency = Data2.from_dictionary(dictionary.get('frequency')) if 'frequency' in dictionary.keys() else APIHelper.SKIP
        duration = Data2.from_dictionary(dictionary.get('duration')) if 'duration' in dictionary.keys() else APIHelper.SKIP
