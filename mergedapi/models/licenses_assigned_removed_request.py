...
class LicensesAssignedRemovedRequest(object):

    """Implementation of the 'LicensesAssignedRemovedRequest' model.
    ...
    def __init__(self,
                 device_list=None):
        """Constructor for the LicensesAssignedRemovedRequest class"""
