...
class CancellationCandidateCreateRequest(object):

    """Implementation of the 'cancellationCandidateCreateRequest' model.
    ...
    def __init__(self,
        ...
        """Constructor for the CancellationCandidateCreateRequest class"""
