...
from mergedapi.models.cloud import Cloud
from mergedapi.models.data_center import DataCenter
from mergedapi.models.ingress_ips import IngressIps
...
class ClusterMetadata(object):
    ...
    Attributes:
        ...
        labels (list of Params): TODO: type description here.
        ingress_ips (IngressIps): TODO: type description here.
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('labels') is not None:
            labels = [Params.from_dictionary(x) for x in dictionary.get('labels')]
        else:
            labels = APIHelper.SKIP
        ingress_ips = IngressIps.from_dictionary(dictionary.get('ingressIps')) if 'ingressIps' in dictionary.keys() else APIHelper.SKIP
