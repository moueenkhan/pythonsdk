...
class CarrierActivateRequest(object):
    ...
    Attributes:
        ...
        custom_fields (list of KvPair): A user-defined descriptive field,
            limited to 50 characters.
        devices (list of DeviceList): Up to 10,000 devices for which you want
            to activate service, specified by device identifier.
