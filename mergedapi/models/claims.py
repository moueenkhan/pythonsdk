...
class Claims(object):
    ...
    """Implementation of the 'claims' model.
    ...
    Attributes:
        ...
        sand_box_state (StateOfSandboxEnum): State of sandbox can have value
            like - STARTED, NOT_STARTED, STOPPED, PAUSED, COMPLETED, DELETED,
            STOP_IN_PROGRESS, PAUSE_IN_PROGRESS, TEST_IN_PROGRESS,
            MARK_FOR_DELETEION.
        sand_box_status (StatusOfSandboxEnum): Status of sandbox can have
            value like - NA, INPROGRESS, SUCCESS, FAILED.
    ...
    def __init__(self,
        ...
        """Constructor for the Claims class"""
