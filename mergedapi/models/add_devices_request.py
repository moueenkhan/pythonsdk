...
class AddDevicesRequest(object):
    ...
    Attributes:
        account_name (string): The billing account to which the devices are
            added.
        custom_fields (list of KvPair): The names and values for any custom
            fields that you want set for the devices as they are added to the
            account.
        devices_to_add (list of DeviceList): The devices that you want to
            add.
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('devicesToAdd') is not None:
            devices_to_add = [DeviceList.from_dictionary(x) for x in dictionary.get('devicesToAdd')]
        else:
            devices_to_add = APIHelper.SKIP
