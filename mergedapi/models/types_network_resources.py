...
class TypesNetworkResources(object):

    """Implementation of the 'types_networkResources' model.
    ...
    def __init__(self,
                 ...
                 max_latency_ms=APIHelper.SKIP,
                 min_availability=APIHelper.SKIP):
        """Constructor for the TypesNetworkResources class"""
        ...
        if max_latency_ms is not APIHelper.SKIP:
    ...
    def from_dictionary(cls,
        ...
        max_latency_ms = dictionary.get("maxLatencyMs") if dictionary.get("maxLatencyMs") else APIHelper.SKIP
        min_availability = dictionary.get("minAvailability") if dictionary.get("minAvailability") else APIHelper.SKIP
        # Return an object of this model
        return cls(min_bandwidth_kbits,
                   service_continuity_support,
                   max_request_rate,
                   max_latency_ms,
                   min_availability)
