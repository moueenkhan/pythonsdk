...
from mergedapi.models.device_list_item import DeviceListItem


class LicensesAssignedRemovedResponse(object):

    """Implementation of the 'LicensesAssignedRemovedResponse' model.
    ...
    Attributes:
        ...
        lic_used_count (int): Number of licenses assigned to devices after the
            request completed.
        device_list (list of DeviceListItem): A JSON object for each device
    ...
    def __init__(self,
        ...
        """Constructor for the LicensesAssignedRemovedResponse class"""
    ...
    def from_dictionary(cls,
        ...
        if dictionary.get('deviceList') is not None:
            device_list = [DeviceListItem.from_dictionary(x) for x in dictionary.get('deviceList')]
        else:
            device_list = APIHelper.SKIP
