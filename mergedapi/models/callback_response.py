...
class CallbackResponse(object):
    ...
    """Implementation of the 'CallbackResponse' model.
    ...
    Attributes:
        txid (string): A unique string that associates the request with the
            ...
            have the same txid.
        status (Status2Enum): QUEUED or COMPLETED. Requests for IoT devices
            with cacheMode=0 (cached) have status=COMPLETED; all other
            requests are QUEUED.
