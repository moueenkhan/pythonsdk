...
from mergedapi.models.subscription_response_1 import SubscriptionResponse1
...
class AccountServiceController(BaseController):
    ...
    def get_account_subscription_list_using_post(self,
        ...
        Args:
            body (SubscriptionRequest): Account Subscription Request
            x_request_id (string, optional): Transaction Id

        Returns:
            SubscriptionResponse1: Response from the API. Subscription
                Response
        ...
        return super().new_api_call_builder.request(
            ...
            .deserialize_into(SubscriptionResponse1.from_dictionary)
