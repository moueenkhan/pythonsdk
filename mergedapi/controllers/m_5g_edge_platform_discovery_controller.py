...
from mergedapi.models.get_mec_platforms_response import GetMECPlatformsResponse
from mergedapi.models.get_regions_response import GetRegionsResponse
from mergedapi.exceptions.types_error_exception import TypesErrorException


class M5gEdgePlatformDiscoveryController(BaseController):

    """A Controller to access Endpoints in the mergedapi API."""
    def __init__(self, config):
        super(M5gEdgePlatformDiscoveryController, self).__init__(config)
    ...
    def get_mecplatforms(self,
        ...
        Returns:
            GetMECPlatformsResponse: Response from the API. MEC platforms
        ...
        return super().new_api_call_builder.request(
            ...
            .deserialize_into(GetMECPlatformsResponse.from_dictionary)
    ...
    def get_regions(self):
        ...
        Returns:
            GetRegionsResponse: Response from the API. List of geographical
                regions
        ...
        return super().new_api_call_builder.request(
            ...
            ResponseHandler()
            .deserializer(APIHelper.json_deserialize)
            .deserialize_into(GetRegionsResponse.from_dictionary)
            .local_error('400', 'HTTP 400 Bad Request', TypesErrorException)
            .local_error('401', 'HTTP 401 Unauthorized', TypesErrorException)
        ).execute()
