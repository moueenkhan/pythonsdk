...
class RepositoryController(BaseController):
    ...
    def __init__(self, config):
        super(RepositoryController, self).__init__(config)
    ...
    def get_repository_list(self,
        ...
        Returns:
            list of Repository1: Response from the API. OK
        ...
        return super().new_api_call_builder.request(
            ...
            .deserialize_into(Repository1.from_dictionary)
    ...
    def create_repository(self,
        ...
        Args:
            account_name (string): User account name.
            body (Repository1): body
            correlation_id (string, optional): TODO: type description here.

        Returns:
            Repository1: Response from the API. Created
