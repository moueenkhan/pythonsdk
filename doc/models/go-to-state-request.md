...
|  --- | --- | --- | --- |
| `devices` | [`List of DeviceList`](../../doc/models/device-list.md) | Optional | Up to 10,000 devices that you want to push to a different state, specified by device identifier. |
...
| `custom_fields` | [`List of KvPair`](../../doc/models/kv-pair.md) | Optional | The names and values of any custom fields that you want to set for the devices. |
